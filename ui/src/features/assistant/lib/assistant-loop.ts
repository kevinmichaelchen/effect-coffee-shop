import { LfmBrowserModel, type BrowserChatMessage } from "#features/assistant/lib/lfm-browser.ts";
import { CoffeeMcpClient, type McpToolCallResult, type PromptToolDefinition } from "#features/assistant/lib/mcp-client.ts";
import {
  ...
  inferForcedToolCall,
  normalizeToolCall,
} from "#features/assistant/lib/assistantTooling.ts";
import { extractToolCall, sanitizeAssistantText } from "#features/assistant/lib/tool-call-parser.ts";
