...
import {
  ...
  prepareCartConfirmationToolParameters,
  prepareOrderConfirmationToolParameters,
...
const assistantToolInputs = [
  ...
  {
    action: "prepare_order_confirmation",
    parameters: prepareOrderConfirmationToolParameters,
    tool: PrepareOrderConfirmationTool,
  },
  {
    action: "prepare_cart_confirmation",
    parameters: prepareCartConfirmationToolParameters,
    tool: PrepareCartConfirmationTool,
  },
