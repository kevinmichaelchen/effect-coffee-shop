...
describe("sqlite row models", () => {
  it.effect("decodes menu rows from snake_case storage keys into camelCase models", () =>
    Effect.gen(function* () {
      ...
      const menuItem = yield* toMenuItem(decoded);
  ...
  it.effect("decodes order rows from snake_case storage keys into camelCase models", () =>
    Effect.gen(function* () {
      ...
      const coffeeOrder = yield* toCoffeeOrder(order, [item]);
  ...
  it.effect("decodes cart rows from snake_case storage keys into camelCase models", () =>
    Effect.gen(function* () {
      ...
      const cartItem = yield* toCartItem(decoded);
