...
import type { Menu } from "@effect-coffee-shop/coffee-domain/menu";
import type { CoffeeOrder, CoffeeOrders, OrderId } from "@effect-coffee-shop/coffee-domain/order";
import type * as Option from "effect/Option";
import type { CheckoutSession } from "@effect-coffee-shop/coffee-domain/checkout-session";
import type {
  CartItemIdRequest,
  CartSnapshot,
  CheckoutCartRequest,
