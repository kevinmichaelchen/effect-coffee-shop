...
export const placeOrder = Effect.fn("CoffeeOrders.placeOrder")(
  function*(request: PlaceOrderRequest): Effect.fn.Return<
    CoffeeOrder,
  ...
  > {
    ...
    if (!menuItem.availableTemperatures.some((availableTemperature) => availableTemperature === temperature)) {
      return yield* new InvalidOrderInputError({
